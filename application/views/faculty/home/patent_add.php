        ...
        <div id="profile">
            <div class="panel panel-info">
                <div class="panel-heading">
                  <h3 class="panel-title">Add New Patent</h3>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" method="post" action="">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="patent_reg_no" />
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="">
                                    <div class='input-group date' id='patent_date'>
                                        <input type='text' class="form-control" name="patent_date"  />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="awarding_country" />
                            </div>
                            <label  class="col-sm-2 control-label">Other Coawardee</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="other_coawardee" />
                            </div>
                        </div>
